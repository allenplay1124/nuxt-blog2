  ...
  <div class="container mx-auto my-3 lg:p-10 p-1">
    <div class="flex flex-col md:flex-row">
      ...
      >
        ...
        >
          <div
            class="text-lg inline-flex items-center mx-2"
          >
            <div class="mr-2">
          ...
          >
            ...
            <div class="p-1 shadow-sm hover:text-blue-500 dark:hover:text-cyan-500 border-b">
        ...
        <div class="flex flex-col lg:w-auto lg:flex-row justify-between items-center my- dark:text-slate-100">
          <nuxt-link v-if="prev" :to="prev.path">
            <div class="border-l-8 border-blue-500 dark:border-cyan-500 bg-slate-200 dark:bg-slate-700 p-2 rounded-lg hover:text-blue-500 dark:hover:text-cyan-500">
              <div>上一篇：</div>
              <div>{{ prev.title }}</div>
            </div>
          </nuxt-link>
          ...
          <nuxt-link v-if="next" :to="next.path">
            <div>
              <div class="border-r-8 border-blue-500 dark:border-cyan-500 bg-slate-200 dark:bg-slate-700 p-2 rounded-lg hover:text-blue-500 dark:hover:text-cyan-500 mt-3 lg:mt-0">
                <div>下一篇：</div>
                <div>{{ next.title }}</div>
              </div>
            </div>
